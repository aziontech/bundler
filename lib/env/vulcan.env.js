...
async function createVulcanEnv(name, value) {
  ...
  try {
    ...
    feedback.error('An error occurred while creating the .azion folder:', error);
    throw error;
  }
  ...
  try {
    ...
    if (error.code !== 'ENOENT') {
      feedback.error('An error occurred while reading the Vulcan environment file:', error);
      throw error;
    }
  }
  ...
  try {
    ...
    feedback.error('An error occurred while writing the Vulcan environment file:', error);
    throw error;
  }
}
