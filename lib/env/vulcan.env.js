...
async function createVulcanEnv(name, value) {
  ...
  try {
    ...
    console.error('An error occurred while creating the .azion folder:', error);
    throw error;
  }
  ...
  try {
    ...
    if (error.code !== 'ENOENT') {
      console.error('An error occurred while reading the Vulcan environment file:', error);
      throw error;
    }
  }
  ...
  try {
    ...
    console.error('An error occurred while writing the Vulcan environment file:', error);
    throw error;
  }
}
