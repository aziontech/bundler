...
function startVulcanProgram() {
  ...
  program
    ...
    .action(async (type, id, options) => {
      ...
      if (type === 'function') { functions.actions.showFunctionsLogs(id, watch); }
  ...
  program
    ...
    .option('--target <type>', 'Type of build target (e.g., vue, next, js)', 'js')
    .option('--entry <string>', 'Code entrypoint (default: ./main.js)', './main.js')
    .option('--version-id <string>', 'Build version ID (default: timestamp string)', generateTimestamp())
    .action(async ({ target, entry, versionId }) => {
