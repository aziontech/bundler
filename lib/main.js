...
const vulcanVersion = packageJSON.version;
...
function startVulcanProgram() {
  ...
  program
    ...
    .action(async (options) => {
      ...
      const frameworkCreateTemplate = FrameworkInitializer[templateChoice];
      if (frameworkCreateTemplate) {
        await frameworkCreateTemplate(projectName);
      } else {
