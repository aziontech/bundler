  ...
  properties: {
    ...
    rules: {
            ...
            properties: {
              ...
              capture: {
                ...
                properties: {
                  regex: {
                    type: 'string',
                    errorMessage: "The 'regex' field must be a string.",
                  },
                  captured: {
                    type: 'string',
                ...
                required: ['regex', 'captured', 'subject'],
                additionalProperties: false,
                errorMessage: {
                  additionalProperties:
                    "No additional properties are allowed in the 'capture' object.",
                  required:
                    "All properties ('regex', 'captured', 'subject') are required in the 'capture' object.",
                },
              },
              runFunction: {
                type: 'object',
      ...
      errorMessage: {
        ...
        oneOf: "Either 'request' or 'response' must be provided, but not both.",
      },
    },
    networkList: {
      type: 'array',
