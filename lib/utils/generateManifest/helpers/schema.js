    ...
    build: {
      ...
      properties: {
        entry: {
          type: 'string',
          errorMessage:
            "The 'entry' field must be a string representing the entry point file path.",
        },
        builder: {
          type: ['string', 'null'],
          enum: ['esbuild', 'webpack', null],
          errorMessage:
            "The 'builder' field must be either 'esbuild', 'webpack', or null.",
        },
        useNodePolyfills: {
          type: 'boolean',
          errorMessage: "The 'useNodePolyfills' field must be a boolean.",
        },
        useOwnWorker: {
          type: 'boolean',
          errorMessage: "The 'useOwnWorker' field must be a boolean.",
        },
        preset: {
          type: 'object',
          properties: {
            ...
            mode: {
              type: 'string',
              errorMessage: "The 'preset.mode' field must be a string.",
            },
          },
          required: ['name', 'mode'],
          ...
          errorMessage: {
            additionalProperties:
              "No additional properties are allowed in the 'preset' object.",
            required:
              "The 'name' and 'mode' fields are required in the 'preset' object.",
          },
        },
        memoryFS: {
          type: 'object',
          properties: {
            injectionDirs: {
              ...
              errorMessage:
                "The 'memoryFS.injectionDirs' field must be an array of strings or null.",
            },
            removePathPrefix: {
              type: ['string', 'null'],
              errorMessage:
                "The 'memoryFS.removePathPrefix' field must be a string or null.",
            },
          },
          additionalProperties: false,
          errorMessage: {
            additionalProperties:
              "No additional properties are allowed in the 'memoryFS' object.",
          },
        },
        custom: {
          type: 'object',
      ...
      errorMessage: {
        additionalProperties:
          "No additional properties are allowed in the 'build' object.",
      },
    },
