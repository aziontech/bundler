...
const TemplatesOptions = {
  // JavaScript: [{}],
  TypeScript: {
    options: [{ value: 'simple-ts-esm', mode: 'compute' }],
  },
  Angular: {
    options: [
  ...
  Next: {
    options: [
      // { value: 'next-ssr', message: 'SSR supported, , mode: 'compute' },
      // { value: 'next-static', message: 'static supported', , mode: 'deliver' },
    ],
  },
  React: {
    options: [
  ...
  Vite: {
    options: [
      { value: 'vite-static', message: 'static supported', mode: 'deliver' },
    ],
  },
  'C++': {
