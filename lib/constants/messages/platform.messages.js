  ...
  logs: {
    ...
    info: {
      ...
      unsupported_log_type:
        'Logs for applications are not yet supported. Please specify "function" instead.',
      no_logs: 'There are no logs.',
    },
    errors: {
      invalid_log_type:
        'Invalid log type. Please specify either "function" or "application".',
    },
  },
  storage: {
    success: {
      file_uploaded_success: (filePath) => `Uploaded file: ${filePath}`,
      statics_uploaded_finish: (successUploadCount) =>
        `${successUploadCount} static assets successfully uploaded to Azion!`,
    },
    info: {},
    errors: {
  ...
  propagation: {
    success: {
      propagation_complete:
        'Application has propagated to the edge networks and is ready to be accessed!',
    },
    info: {
