...
const response_cache_1 = __importDefault(require("next/dist/server/response-cache"));
const incremental_cache_1 = require("next/dist/server/lib/incremental-cache");
...
class NextComputeJsServer extends base_server_1.default {
    constructor(options) {
        ...
        (0, load_components_1.loadComponents)(this.serverOptions.computeJs.assets, this.distDir, '/_document', this.dir, this._isLikeServerless, false, false).catch(() => { });
        (0, load_components_1.loadComponents)(this.serverOptions.computeJs.assets, this.distDir, '/_app', this.dir, this._isLikeServerless, false, false).catch(() => { });
    }
    ...
    getResponseCache({ dev }) {
        ...
        const incrementalCache = new incremental_cache_1.IncrementalCache({
            ...
            incrementalCacheHandlerPath: (_a = this.nextConfig.experimental) === null || _a === void 0 ? void 0 : _a.incrementalCacheHandlerPath,
    ...
    generatePublicRoutes() {
        const publicFiles = new Set((0, require_1.assetDirectory)(this.serverOptions.computeJs.assets, this.publicDir, this.dir).map((p) => {
    ...
    getFilesystemPaths() {
        ...
        let userFilesPublic = [];
        if (this.publicDir) {
            userFilesPublic = (0, require_1.assetDirectory)(this.serverOptions.computeJs.assets, (0, path_1.join)(this.dir, constants_1.CLIENT_PUBLIC_FILES_PATH), this.dir);
        }
        let nextFilesStatic = [];
        if (!this.minimalMode) {
            userFilesStatic = (0, require_1.assetDirectory)(this.serverOptions.computeJs.assets, (0, path_1.join)(this.distDir, 'static'), this.dir);
        }
    ...
    async runApi(req, res, query, params, page, builtPagePath) {
        ...
        //   }
        // }
        await (0, node_1.apiResolver)(req.originalRequest, res.originalResponse, query, pageModule, {
    ...
    getPagePath(pathname, locales) {
        return (0, require_1.getPagePath)(this.serverOptions.computeJs.assets, pathname, this.dir, this.distDir, this._isLikeServerless, this.renderOpts.dev, locales, this.nextConfig.experimental.appDir);
    }
    ...
    async findPageComponents({ pathname, query, params, isAppPath, }) {
        let paths = [
            ...
            query.amp ?
                (isAppPath ?
                    ...
                    (0, normalize_page_path_1.normalizePagePath)(pathname)) + '.amp' : null,
            pathname,
        ].filter(Boolean);
        ...
        for (const pagePath of paths) {
            try {
                const components = await (0, load_components_1.loadComponents)(this.serverOptions.computeJs.assets, this.distDir, pagePath, this.dir, !this.renderOpts.dev && this._isLikeServerless, !!this.renderOpts.serverComponents, isAppPath);
                if (query.__nextLocale &&
    ...
    generateRoutes() {
        ...
        const catchAllRoute = {
            ...
            fn: async (req, res, _params, parsedUrl) => {
                ...
                if (this.nextConfig.i18n) {
                    const localePathResult = (0, normalize_locale_path_1.normalizeLocalePath)(pathname, (_a = this.nextConfig.i18n) === null || _a === void 0 ? void 0 : _a.locales);
                    if (localePathResult.detectedLocale) {
                        pathname = localePathResult.pathname;
    ...
    attachRequestMeta(req, parsedUrl) {
        ...
        const initUrl = this.hostname && this.port
