...
class Dispatcher {
   ...
   * @param {object} currentConfig.build - The current build id.
   * @param {object} currentConfig.useNodePolyfills - The current useNodePolyfills.
   * @param {object} currentConfig.useOwnWorker - The current useOwnWorker.
