...
async function createAzionConfigFile(useCommonJS, module) {
  ...
  // Convertendo o objeto de módulo para string JSON
  ...
  const formattedContent = await prettier.format(
    ...
    {
      parser: 'babel', // Use o parser babel para garantir compatibilidade com código JS
      semi: false, // Controla a inserção de ponto e vírgula
      singleQuote: true, // Usa aspas simples
      trailingComma: 'none', // Remove vírgulas finais
    },
  );

  // Escrevendo o conteúdo formatado no arquivo
