...
import unenvPresetAzion from '../../../helpers/unenv-preset.js';
...
function nodeBuiltInModules(build, isProd) {
  ...
  build.onLoad(
    ...
    async (args) => {
      ...
      const isFullPath = fileExtensions.includes(
        path.extname(absolutePathNodeModules),
      );
      const contents = await fs.promises.readFile(
        isFullPath ? absolutePathNodeModules : `${absolutePathNodeModules}.mjs`,
        'utf8',
      );
