...
function unimplemented(name) {
  throw new Error(
    `Node.js process ${name} is not supported by JSPM core outside of Node.js`,
  );
}
...
export var binding = function (name) {
  unimplemented('binding');
};

export var umask = function (mask) {
  return 0;
};

export var cwd = function () {
  return '/';
};
 ...
 * @param name
 */
export function _linkedBinding(name) {
 ...
 * @param name
 */
export function dlopen(name) {
  unimplemented('dlopen');
}
/**
 *
 */
export function _getActiveRequests() {
  return [];
}
/**
 *
 ...
 *
 */
export function hasUncaughtExceptionCaptureCallback() {
  return false;
}
 ...
 * @param name
 */
export function listeners(name) {
  return [];
}
